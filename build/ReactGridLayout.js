...
var ReactGridLayout = /*#__PURE__*/ (function(_React$Component) {
  ...
  function ReactGridLayout(
    ...
    _defineProperty(_assertThisInitialized(_this), "onClick", function(
      ...
      if (!_this.state.pureClick) return;
      var _this$props3 = _this.props,
        droppingItem = _this$props3.droppingItem,
      ...
      var grid = e.nativeEvent.target || e.nativeEvent.srcElement;
      ...
      if (!_this.state.droppingDOMNode) {
        ...
        var item = (0, _utils.getFirstCollision)(layout, {
          i: "__tmp",
          x: x,
          y: y,
          w: 1,
      ...
      },
      {
        ...
        value: function onResize(
          ...
          var _this$props5 = this.props,
            ...
            preventCollision = _this$props5.preventCollision;
          var l =
            /*: ?LayoutItem*/
      ...
      },
      {
        ...
        value: function placeholder() /*: ?ReactElement<any>*/
        {
          ...
          var _this$props6 = this.props,
            ...
            transformScale = _this$props6.transformScale; // {...this.state.activeDrag} is pretty slow, actually
        ...
        value: function render() {
          ...
          return /*#__PURE__*/ _react.default.createElement(
            "div",
            {
              ...
              onClick: this.onClick ? this.onClick : _utils.noop,
